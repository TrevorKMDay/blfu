...
#SBATCH -o /home/feczk001/shared/projects/BLFU/code/nordic/nordic_logs/nordicsbatch_%A_%a.out
#SBATCH -e /home/feczk001/shared/projects/BLFU/code/nordic/nordic_logs/nordicsbatch_%A_%a.err
#SBATCH -A elisonj
...
NONORDIC=`echo ${MAG} | sed -e s/_part-mag_/_/ | \
                        sed -E 's/_task-([^_]*)_/_task-\1NoNORDIC_/'` 
